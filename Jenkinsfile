node {
   ...
   stage('Deploy') {
     ...
     {
        sh "/usr/local/bin/docker-machine create --driver amazonec2 --amazonec2-open-port 80 --amazonec2-region us-west-2 --amazonec2-access-key ${amazonec2_access_key} --amazonec2-secret-key ${amazonec2_secret_key} ${manchineName}"
